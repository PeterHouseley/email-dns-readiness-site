...
executive_trust_ledger_svg = """<svg xmlns='http://www.w3.org/2000/svg' width='1180' height='700' viewBox='0 0 1180 700' role='img' aria-labelledby='ledgerTitle ledgerDesc'>
  <title id='ledgerTitle'>Executive email trust ledger</title>
  <desc id='ledgerDesc'>A polished owner-safe ledger showing sender approvals, DNS evidence, resolver readbacks and monthly drift receipts for email authentication monitoring.</desc>
  <defs>
    <filter id='shadow' x='-18%' y='-18%' width='136%' height='142%'><feDropShadow dx='0' dy='24' stdDeviation='22' flood-color='#071a22' flood-opacity='.28'/></filter>
    <pattern id='ledgerLines' width='52' height='52' patternUnits='userSpaceOnUse'><path d='M0 52H52 M52 0V52' fill='none' stroke='#173047' stroke-opacity='.07'/></pattern>
    <linearGradient id='header' x1='0' x2='1'><stop offset='0' stop-color='#173047'/><stop offset='1' stop-color='#2f745d'/></linearGradient>
    <linearGradient id='stamp' x1='0' x2='1'><stop offset='0' stop-color='#d7b75d'/><stop offset='1' stop-color='#9c721d'/></linearGradient>
  </defs>
  <rect width='1180' height='700' rx='46' fill='#eef2ec'/>
  <rect x='28' y='28' width='1124' height='644' rx='36' fill='url(#ledgerLines)'/>
  <g filter='url(#shadow)'>
    <rect x='76' y='72' width='1028' height='556' rx='34' fill='#fffdf7' stroke='#173047' stroke-opacity='.14'/>
  </g>
  <rect x='76' y='72' width='1028' height='112' rx='34' fill='url(#header)'/>
  <g font-family='Georgia,serif'>
    <text x='116' y='132' fill='#fffdf7' font-size='42' font-weight='700'>executive trust ledger</text>
    <text x='116' y='166' fill='#cde5dc' font-size='20'>the monthly email-auth record a business owner can actually understand</text>
  </g>
  <g transform='translate(806 104)' font-family='ui-monospace, Menlo, Consolas, monospace'>
    <rect width='252' height='58' rx='18' fill='rgba(255,255,255,.12)' stroke='#cde5dc' stroke-opacity='.24'/>
    <text x='22' y='36' fill='#fffdf7' font-size='17' font-weight='950'>NO PASSWORDS · PUBLIC DNS</text>
  </g>
  <g transform='translate(116 228)' font-family='ui-sans-serif, system-ui, sans-serif'>
    <g font-size='15' font-weight='950' letter-spacing='.1em' fill='#536172'>
      <text x='0' y='0'>SENDER</text><text x='260' y='0'>EVIDENCE</text><text x='520' y='0'>READBACK</text><text x='760' y='0'>OWNER ACTION</text>
    </g>
    <g transform='translate(0 28)' font-size='19' fill='#132338'>
      <rect width='948' height='78' rx='19' fill='#eef6f1'/>
      <text x='24' y='48' font-weight='900'>Microsoft 365</text><text x='260' y='48'>SPF + MX aligned</text><text x='520' y='48' fill='#2f745d' font-weight='900'>PASS</text><text x='760' y='48'>file receipt</text>
    </g>
    <g transform='translate(0 122)' font-size='19' fill='#132338'>
      <rect width='948' height='78' rx='19' fill='#fff6dd'/>
      <text x='24' y='48' font-weight='900'>Newsletter app</text><text x='260' y='48'>DKIM clue only</text><text x='520' y='48' fill='#9c721d' font-weight='900'>AMBER</text><text x='760' y='48'>confirm selector</text>
    </g>
    <g transform='translate(0 216)' font-size='19' fill='#132338'>
      <rect width='948' height='78' rx='19' fill='#f1ded8'/>
      <text x='24' y='48' font-weight='900'>Old CRM</text><text x='260' y='48'>SPF include found</text><text x='520' y='48' fill='#98493b' font-weight='900'>REVIEW</text><text x='760' y='48'>approve/remove</text>
    </g>
    <path d='M24 360H924' stroke='#d7d1bd' stroke-width='2'/>
    <g transform='translate(0 386)'>
      <rect width='948' height='74' rx='24' fill='#173047'/>
      <text x='24' y='30' fill='#cde5dc' font-family='ui-monospace, Menlo, monospace' font-size='15' font-weight='950'>MONTHLY DIGEST CLOSE</text>
      <text x='24' y='54' fill='#fffdf7' font-size='19' font-weight='850'>baseline compared · drift explained · DNS editor note ready · owner-safe next action</text>
      <circle cx='876' cy='37' r='48' fill='none' stroke='url(#stamp)' stroke-width='7'/>
      <text x='876' y='33' text-anchor='middle' fill='#d7b75d' font-family='ui-monospace, Menlo, monospace' font-size='13' font-weight='950'>RECEIPT</text>
      <text x='876' y='51' text-anchor='middle' fill='#d7b75d' font-family='ui-monospace, Menlo, monospace' font-size='13' font-weight='950'>FILED</text>
    </g>
  </g>
</svg>"""
...
(OUT / "executive-trust-ledger.svg").write_text(executive_trust_ledger_svg, encoding="utf-8")

mailbox_migration_cutover_svg = '''<svg xmlns='http://www.w3.org/2000/svg' width='1180' height='700' viewBox='0 0 1180 700' role='img' aria-labelledby='title desc'>
  <title id='title'>Mailbox migration cutover board</title>
  <desc id='desc'>A premium operational board showing old mailbox systems, approved senders, DNS cutover checks and public resolver receipts for an email migration.</desc>
  <defs>
    <filter id='shadow' x='-18%' y='-20%' width='136%' height='145%'><feDropShadow dx='0' dy='24' stdDeviation='20' flood-color='#04131a' flood-opacity='.32'/></filter>
    <pattern id='grid' width='36' height='36' patternUnits='userSpaceOnUse'><path d='M36 0H0v36' fill='none' stroke='#9ed9ca' stroke-opacity='.1'/></pattern>
    <linearGradient id='lane' x1='0' x2='1'><stop offset='0' stop-color='#72e2a3'/><stop offset='.52' stop-color='#ffd36e'/><stop offset='1' stop-color='#8fe1ff'/></linearGradient>
    <linearGradient id='panel' x1='0' y1='0' x2='1' y2='1'><stop offset='0' stop-color='#fffdf7'/><stop offset='1' stop-color='#e5efe9'/></linearGradient>
  </defs>
  <rect width='1180' height='700' rx='46' fill='#06161d'/>
  <rect x='28' y='28' width='1124' height='644' rx='34' fill='url(#grid)' stroke='#9ed9ca' stroke-opacity='.18'/>
  <g font-family='Georgia,serif' fill='#e9fbf8'>
    <text x='70' y='118' font-size='44' font-weight='700'>mailbox migration cutover board</text>
    <text x='70' y='158' font-size='21' fill='#a7d8ca'>before Microsoft 365, Google Workspace, CRM or form mail changes go live</text>
  </g>
  <g filter='url(#shadow)'>
    <rect x='70' y='208' width='1040' height='390' rx='34' fill='url(#panel)'/>
  </g>
  <g font-family='ui-sans-serif,system-ui,sans-serif'>
    <path d='M148 333H1030' stroke='url(#lane)' stroke-width='12' stroke-linecap='round'/>
    <g text-anchor='middle' font-weight='950' font-size='18'>
      <g transform='translate(148 333)'><circle r='48' fill='#0b2730' stroke='#72e2a3' stroke-width='6'/><text y='6' fill='#e9fbf8'>OLD</text><text y='86' fill='#536172' font-size='16'>current records</text></g>
      <g transform='translate(368 333)'><circle r='48' fill='#0b2730' stroke='#ffd36e' stroke-width='6'/><text y='6' fill='#e9fbf8'>SPF</text><text y='86' fill='#536172' font-size='16'>sender inventory</text></g>
      <g transform='translate(588 333)'><circle r='48' fill='#0b2730' stroke='#ffd36e' stroke-width='6'/><text y='6' fill='#e9fbf8'>DKIM</text><text y='86' fill='#536172' font-size='16'>selector proof</text></g>
      <g transform='translate(808 333)'><circle r='48' fill='#0b2730' stroke='#8fe1ff' stroke-width='6'/><text y='6' fill='#e9fbf8'>MX</text><text y='86' fill='#536172' font-size='16'>mail route</text></g>
      <g transform='translate(1030 333)'><circle r='48' fill='#0b2730' stroke='#72e2a3' stroke-width='6'/><text y='6' fill='#e9fbf8'>LIVE</text><text y='86' fill='#536172' font-size='16'>resolver receipt</text></g>
    </g>
    <g transform='translate(112 478)' font-size='17' fill='#132338'>
      <rect width='292' height='74' rx='18' fill='#eef6f1'/><text x='22' y='31' font-weight='950'>1. freeze the sender list</text><text x='22' y='55' fill='#536172'>no mystery tools survive cutover</text>
      <g transform='translate(332 0)'><rect width='292' height='74' rx='18' fill='#fff4d9'/><text x='22' y='31' font-weight='950'>2. approve change order</text><text x='22' y='55' fill='#6f5a2a'>SPF, DKIM, DMARC, MX separated</text></g>
      <g transform='translate(664 0)'><rect width='292' height='74' rx='18' fill='#e9f6fb'/><text x='22' y='31' font-weight='950'>3. read back publicly</text><text x='22' y='55' fill='#536172'>Google, Cloudflare, authoritative</text></g>
    </g>
  </g>
  <g font-family='ui-monospace,Menlo,monospace'>
    <rect x='810' y='86' width='300' height='72' rx='18' fill='rgba(255,255,255,.08)' stroke='#9ed9ca' stroke-opacity='.24'/>
    <text x='834' y='118' fill='#ffd36e' font-size='16' font-weight='900'>CUTOVER STATUS: AMBER</text>
    <text x='834' y='142' fill='#e9fbf8' font-size='15'>safe to edit after owner sign-off</text>
  </g>
</svg>
'''
(OUT / 'mailbox-migration-cutover-board.svg').write_text(mailbox_migration_cutover_svg)

for name in ["dns-routing-map.svg", "auth-stack-meter.svg", "resolver-verification-receipt.svg", "email-trust-incident-drill.svg", "domain-trust-seal.svg", "sender-inventory-manifest.svg", "dmarc-drift-digest.svg", "missed-reply-loss-ledger.svg", "executive-trust-ledger.svg", "mailbox-migration-cutover-board.svg"]:
    print(OUT / name)
